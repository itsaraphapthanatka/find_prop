...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'โกดัง โรงงาน โชว์รูม ออฟฟิศ — เก็บครบ ~50 ฟิลด์ต่อทรัพย์ พร้อมรูปภาพ ค้นหา/กรองทันใจ (รวมสถานะ ว่าง/เช่าแล้ว/ขายแล้ว) แผนที่หมุดแยกสีตามประเภท สลับภาพดาวเทียม และค้นหาที่อยู่เพื่อปักหมุดได้ฟรี',
  ...
  },
  {
    ...
    desc: 'นัดติดตามผูกกับทรัพย์แต่ละตัว จดผลทุกครั้ง (โทรไม่รับ นัดเลื่อน เจ้าของขอคิดก่อน) เป็นประวัติย้อนดูได้ แจ้งเตือนถึงมือถือเช้าวันนัด — ปิดดีลแล้วกด "เช่าแล้ว/ขายแล้ว" ป้ายสถานะขึ้นทุกหน้าทันที',
