...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'เลือกทรัพย์ 2–4 ตัว ระบบสร้างตารางเทียบสเปก + บทวิเคราะห์จาก AI พิมพ์เป็น PDF แนวนอนสวยงาม — บันทึกเป็นชอร์ตลิสต์เก็บไว้ กลับมาเปิดต่อ/เสนอลูกค้ารายอื่นได้ ไม่ต้องเลือกทรัพย์ใหม่และไม่ต้องให้ AI เขียนซ้ำ',
    icon: <IconCompare size={22} />,
  },
  {
    title: 'ส่งลิงก์ให้ลูกค้าดู ราคาไม่เปลี่ยนกลางทาง',
    desc: 'ส่งลิงก์ทาง LINE ลูกค้ากดเปิดดูได้เลย ไม่ต้องล็อกอินไม่ต้องติดตั้งอะไร · ลิงก์มีวันหมดอายุและยกเลิกได้ทุกเมื่อ · ลูกค้าไม่เห็นชื่อ/เบอร์เจ้าของทรัพย์ บ้านเลขที่ และพิกัด — ตัดปัญหาลูกค้าติดต่อเจ้าของข้ามหัวคุณ · ราคาถูกตรึงไว้ตามวันที่เสนอ เจ้าของขึ้นราคาทีหลังลูกค้ายังเห็นราคาที่คุณเสนอ · ดูได้ว่าลูกค้าเปิดอ่านแล้วกี่ครั้ง',
...
const COMPARE: { label: string; free: boolean | string; pro: boolean | string }[] = [
  ...
  { label: 'ส่งลิงก์ให้ลูกค้าดู (ไม่ต้องล็อกอิน) + ตั้งวันหมดอายุ + ตรึงราคาวันที่เสนอ', free: true, pro: true },
